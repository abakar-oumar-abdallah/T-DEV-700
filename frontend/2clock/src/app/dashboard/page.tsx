  ...
  return (
    <main className="p-6 sm:p-10 min-h-screen">
        ...
        <div className="relative z-10">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-shrink-0">
              <Image src="/2clock.svg" alt="2clock logo" width={48} height={48} />
            </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {currentTeam?.role === 'owner' || currentTeam?.role === 'manager' ? (
        <Link href="/dashboard/kpi" className={`transition-all duration-500 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '300ms' }}>
          <article className="group bg-white rounded-xl shadow-md p-6 hover:shadow-2xl transition-all duration-300 cursor-pointer border-t-4 border-[#3bb273] hover:-translate-y-2 overflow-hidden relative">
            ...
            <div className="flex flex-col items-center text-center relative z-10">
              ...
              <p className="text-gray-600 group-hover:text-gray-800 transition-colors duration-300">Visualisez les statistiques des membres de votre équipe</p>
            </div>
          </article>
        </Link>
        ):''} 
