  ...
  return (
    ...
    >
      ...
      <div className="flex-1 sm:ml-64 flex flex-col items-center w-full">
        ...
        <main className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 items-start py-8 px-4">
            ...
            <div className="max-w-md mx-auto bg-white rounded-xl shadow p-6">
              ...
              <div className="grid grid-cols-3 gap-4 mb-4">
                {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((n) => (
                  <button
                    ...
                    className="h-16 bg-gray-100 rounded-md flex items-center justify-center text-lg font-medium hover:bg-gray-200"
                  >
                    {n}
                  </button>
                ))}
                ...
                <button
                  onClick={() => press("0")}
                  className="h-16 bg-gray-100 rounded-md flex items-center justify-center text-lg font-medium"
                >
                  0
                </button>
                <button
              ...
              <div>
                <button
                  ...
                  disabled={loading}
                  className="w-full bg-[var(--color-primary)] text-white py-3 rounded-md hover:opacity-90 transition"
                >
          ...
          <aside className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow p-6">
              ...
              <div className="space-y-4">
                {history.length === 0 && (
                  <div className="text-sm text-gray-400">Aucun pointage</div>
                )}
                {history.map((h) => (
